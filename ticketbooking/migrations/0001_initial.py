# Generated by Django 5.0.1 on 2025-05-13 18:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pnr', models.CharField(default=ticketbooking.models.generate_pnr, editable=False, max_length=8)),
                ...
                ('train', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='ticketbooking.train')),
            ],
        ),
    ]
