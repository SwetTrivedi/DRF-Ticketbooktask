# Generated by Django 5.0.1 on 2025-05-12 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('booked', 'Booked'), ('waiting', 'Waiting')], default='booked', max_length=10)),
                ('seat_class', models.CharField(max_length=20)),
                ('number_of_seats', models.PositiveIntegerField()),
                ('train_number', models.CharField(max_length=20)),
                ('departure_date', models.DateField(default=ticketbooking.models.get_current_date)),
                ('departure_time', models.TimeField(default='14:30:00')),
                ('destination', models.CharField(max_length=100)),
                ('pnr_number', models.CharField(default=ticketbooking.models.generate_pnr, max_length=8, unique=True)),
